...
public class AdicionarFilmeWindow extends JFrame {
    ...
    public AdicionarFilmeWindow(FilmesWindow filmesWindow, String usuario) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Filme filme = new Filme(nomeFilme, comentario, nota);
        FilmesController controller = new FilmesController();

        controller.adicionarFilme(usuario, filme);
